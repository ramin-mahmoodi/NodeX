...
<body class="min-h-screen p-4 sm:p-8 relative">
    ...
    <script>
                ...
                container.innerHTML += \`
                    <div class="flex items-center justify-between p-3 hover:bg-slate-50 dark:hover:bg-zinc-800/50 transition-colors" style="direction: ltr;">
                        ...
                        <div class="flex items-center gap-2 flex-shrink-0 ml-4">
                            ...
                            <button aria-label="QR" title="QR" type="button" onclick="toggleQR(event, '\${n.raw_uri}', '\${n.name.replace(/'/g, "\\'")}', true)" class="flex items-center justify-center w-7 h-7 rounded border border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-500 transition-colors">
        ...
        function toggleQR(event, text, title = 'NodeX Sub', alwaysLeft = false) {
            ...
            if (currentLang === 'en' && !alwaysLeft) {
                // English main sub: ALWAYS try right first
